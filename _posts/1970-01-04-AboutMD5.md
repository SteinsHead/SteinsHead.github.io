...
layout: post
title:  "使用C++计算文件的MD5值"
date:   1970-01-04 00:00 +0800
categories: christina update
---
最近由于正在操作一些百度网盘上传文件相关的操作，因此遇到了上传文件需要加入md5编码的问题

#### 资料来源

RFC 1321 [The MD5 Message-Digest Algorithm](https://tools.ietf.org/html/rfc1321) 采用官网上的方法来生成md5码

#### 生成步骤

- 编写md5全局头文件（md5global.h）
...
![main函数对于文件的整体md5测试](https://cdn.jsdelivr.net/gh/SteinsHead/ImageBed/img/2020/20201006161339.png) ![md5的输出结果](https://cdn.jsdelivr.net/gh/SteinsHead/ImageBed/img/2020/20201006161409.png)

- 后续我会加入文件分块并分开获取md5码的代码工作
